...
impl VersionField {
    ...
    pub fn from_query_json(version_id : i64, loader_fields : Option<serde_json::Value>, version_fields : Option<serde_json::Value>, loader_field_enum_values : Option<serde_json::Value>) -> Vec<VersionField> {
