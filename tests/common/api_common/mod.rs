...
pub trait ApiProject {
    ...
    async fn remove_project(&self, id_or_slug: &str, pat: Option<&str>) -> TestResponse;
...
#[async_trait(?Send)]
pub trait ApiTeams {
    async fn get_team_members(&self, team_id: &str, pat: Option<&str>) -> TestResponse;
    async fn get_team_members_deserialized_common(
        &self,
        team_id: &str,
        pat: Option<&str>,
    ) -> Vec<CommonTeamMember>;
    async fn get_teams_members(&self, team_ids: &[&str], pat: Option<&str>) -> TestResponse;
    async fn get_project_members(&self, id_or_slug: &str, pat: Option<&str>) -> TestResponse;
    ...
    async fn get_notifications(&self, ids: &[&str], pat: Option<&str>) -> TestResponse;
    async fn mark_notification_read(
        &self,
        notification_id: &str,
        pat: Option<&str>,
    ) -> TestResponse;
    async fn mark_notifications_read(&self, ids: &[&str], pat: Option<&str>) -> TestResponse;
...
#[async_trait(?Send)]
pub trait ApiUser {
    async fn get_user(&self, id_or_username: &str, pat: Option<&str>) -> TestResponse;
    ...
    async fn delete_user(&self, id_or_username: &str, pat: Option<&str>) -> TestResponse;
}
...
pub trait ApiVersion {
    ...
    async fn get_versions(&self, ids: Vec<String>, pat: Option<&str>) -> TestResponse;
    ...
    async fn remove_version(&self, id_or_slug: &str, pat: Option<&str>) -> TestResponse;
...
// Impl this on all axum_test::TestRequest
