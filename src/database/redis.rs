...
impl RedisPool {
    ...
    where
        ...
        K: Display + Hash + Eq + PartialEq + Clone + DeserializeOwned + Serialize + Debug + Send,
    {
        Ok(self
    ...
    where
        ...
        Fut: Future<Output = Result<DashMap<K, (Option<S>, T)>, DatabaseError>> + Send,
        T: Serialize + DeserializeOwned + Send,
        I: Display + Hash + Eq + PartialEq + Clone + Debug + Send,
        K: Display + Hash + Eq + PartialEq + Clone + DeserializeOwned + Serialize + Send,
